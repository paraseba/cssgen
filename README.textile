...
** keywords,
** strings,
** any other typo convertible to string with <code>as-str</code>,
...
property above. Of course, if everything is "literal", you could do <code>:padding "1px 2px 3px 4px"</code>.
